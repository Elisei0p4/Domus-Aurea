...
class StoreViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.product = ProductFactory(category=self.category, name='Тестовый товар', slug='view-product')
    ...
    def test_product_list_by_category_view(self):
        ...
        other_product = ProductFactory(name='Другой товар')
    ...
    def test_product_list_filtering_and_sorting(self):
        ...
        ProductFactory(name='Дешевый', base_price=Decimal('100.00'), discount=0)
        ProductFactory(name='Дорогой', base_price=Decimal('1000.00'), discount=0)
    ...
    def test_review_submission(self):
        ...
        post_data = {
            ...
            'submit_review': 'submit' # Добавлено недостающее поле
        }
